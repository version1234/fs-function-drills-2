...
// CODE HERE 
let contains = (arr,y,z)  => z(arr.includes(y))
...
uniq(names, uniqNames => 
  console.log("Unique ArrayList is : "+  uniqNames)
)
...
const each = (arr,z) => arr.forEach((element,i) => z(element,i));
...
console.log(addNINE(25))
console.log(addNINE(26))
