...
// CODE HERE
let saleTaxTotal = orders.map((elem)=>{
return (1 + elem.tax)*elem.price
})

console.log(saleTaxTotal);
////////// PROBLEM 6 //////////
...
// CODE HERE
// let justBob = purchases.filter(function(elem.owner= Bob))
// const bobTotal = purchases.reduce(function(acc,curr){
//   return acc+curr;
// })
// console.log(bobTotal);
const justBob = purchases.filter(element => (element.owner === 'Bob'))

let bobTotal = justBob.reduce(function(acc, curr){
